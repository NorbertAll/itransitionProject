...
const EnhancedTableToolbar = (props) => {
  ...
  let navigate=useNavigate();
    ...
    const addadmin= (selected)=>{
      axios.post("http://localhost:3001/user/addadmin", {...selected})
      
         window.location.reload(false)
    }
    const delladmin= (selected)=>{
      axios.post("http://localhost:3001/user/deladmin", {...selected})
  ...
  return (
    ...
    >
      ...
      <Tooltip title="give admin">
            <IconButton onClick={() => addadmin(selected)}>
                <FontDownloadIcon />
            </IconButton>
      </Tooltip>
      <Tooltip title="remove admin rights">
            <IconButton onClick={() => delladmin(selected)}>
                <FontDownloadOffIcon />
            </IconButton>
      </Tooltip>
    </>
